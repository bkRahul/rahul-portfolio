...
(0, _jqueryDefault.default)(document).ready(function() {
    // nav menu script
    (0, _jqueryDefault.default)("#nav-menu").ready(function() {
        (0, _jqueryDefault.default)('a[href*="#"]').bind("click", function(e) {
            e.preventDefault(); // prevent hard jump, the default behavior
            var target = (0, _jqueryDefault.default)(this).attr("href"); // Set the target as variable
            // perform animated scrolling by getting top-position of target-element and set it as scroll target
            (0, _jqueryDefault.default)("html, body").stop().animate({
                scrollTop: (0, _jqueryDefault.default)(target).offset().top
            }, 500);
            return false;
        });
    });
    (0, _jqueryDefault.default)(window).scroll(function() {
        var scrollDistance = (0, _jqueryDefault.default)(window).scrollTop();
        //height from top till div
        var divdist = (0, _jqueryDefault.default)("#personal-projects").offset().top - 250;
        //total height of div
        var divdistheight = (0, _jqueryDefault.default)("#personal-projects").outerHeight(true);
        // total height of div and scroll screen
        var tot = divdist + divdistheight - 250;
        if (scrollDistance >= divdist && scrollDistance <= tot) {
            revealSections();
            (0, _jqueryDefault.default)(".nav-container li .dot-label").addClass("white");
        } else (0, _jqueryDefault.default)(".nav-container li .dot-label").removeClass("white");
    }).scroll();
    (0, _jqueryDefault.default)(window).scroll(function(event) {
        var divider = (0, _jqueryDefault.default)(".divider");
        divider.each(function(i, el) {
            var el = (0, _jqueryDefault.default)(el);
            if (isVisible(el)) el.addClass("line");
            else el.removeClass("line");
        });
        var scrollDistance = (0, _jqueryDefault.default)(window).scrollTop();
        //Show/hide menu on scroll
        if (scrollDistance >= 300) (0, _jqueryDefault.default)("#nav-menu").addClass("active");
        else (0, _jqueryDefault.default)("#nav-menu").removeClass("active");
        // Assign active class to nav links while scolling
        (0, _jqueryDefault.default)(".section").each(function(i) {
            if ((0, _jqueryDefault.default)(this).position().top <= scrollDistance) {
                (0, _jqueryDefault.default)("#nav-menu a.active").removeClass("active");
                (0, _jqueryDefault.default)("#nav-menu a").eq(i).addClass("active");
            }
        });
    }).scroll();
    // Accordion
    (0, _jqueryDefault.default)(document).on("click", ".accordion-section .menu div", function() {
        var numberIndex = (0, _jqueryDefault.default)(this).index();
        if (!(0, _jqueryDefault.default)(this).is(".active")) {
            (0, _jqueryDefault.default)(".accordion-section .menu div").removeClass("active");
            (0, _jqueryDefault.default)(".accordion-section ul li").removeClass("active");
            (0, _jqueryDefault.default)(this).addClass("active");
            (0, _jqueryDefault.default)(".accordion-section ul").find("li:eq(" + numberIndex + ")").addClass("active");
        }
    });
    //theme change
    ...
    for(var i1 = 0; i1 < toggleSwitch.length; i1++)toggleSwitch[i1].addEventListener("click", switchTheme, false);
    //save to local storage
    const currentTheme = localStorage.getItem("theme") ? localStorage.getItem("theme") : null;
    if (currentTheme) document.documentElement.setAttribute("data-theme", currentTheme);
    //Hamburger menu
    (0, _jqueryDefault.default)("#burger-menu").click(function() {
        (0, _jqueryDefault.default)(this).toggleClass("open");
        (0, _jqueryDefault.default)(".mobile_menu").toggleClass("menu_activated");
        (0, _jqueryDefault.default)("body").toggleClass("no-scroll");
    });
    (0, _jqueryDefault.default)(".menu__group a").click(function() {
        (0, _jqueryDefault.default)("#burger-menu").toggleClass("open");
        (0, _jqueryDefault.default)(".mobile_menu").toggleClass("menu_activated");
        (0, _jqueryDefault.default)("body").toggleClass("no-scroll");
    });
    //reveal function
    function revealSections() {
        var posts = (0, _jqueryDefault.default)(".grid-item:not(.reveal)");
        var i = 0;
        setInterval(function() {
            if (i >= posts.length) return false;
            var el = posts[i];
            (0, _jqueryDefault.default)(el).addClass("reveal");
            i++;
        }, 300);
    }
    function isVisible(element) {
        var scroll_pos = (0, _jqueryDefault.default)(window).scrollTop();
        var window_height = (0, _jqueryDefault.default)(window).height();
        var el_top = (0, _jqueryDefault.default)(element).offset().top;
        var el_height = (0, _jqueryDefault.default)(element).height();
        var el_bottom = el_top + el_height;
        return el_bottom - el_height * 0.25 > scroll_pos && el_top < scroll_pos + 0.5 * window_height;
    }
    //fixed navbar
    var c, currentScrollTop = 0, navbar = (0, _jqueryDefault.default)(".mobile_menu");
    (0, _jqueryDefault.default)(window).scroll(function() {
        var a = (0, _jqueryDefault.default)(window).scrollTop();
        var b = navbar.height();
        currentScrollTop = a;
        if (c < currentScrollTop && a > b + b) navbar.addClass("scrollUp");
        else if (c > currentScrollTop && !(a <= b)) navbar.removeClass("scrollUp");
        c = currentScrollTop;
    });
});
...
},{}]},["jQVXF","1SICI"], "1SICI", "parcelRequire0de4")
